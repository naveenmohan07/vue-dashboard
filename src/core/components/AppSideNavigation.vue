...
<template>
  <div class="sidebar-wrapper w-fit bg-primary">
    <div class="sidebar px-6 h-full border-r-[1.5px] border-r-[#727171] flex flex-col">
      <div class="sidebar-header py-6">
        <p class="flex justify-center text-[#cdcbcb]">CN</p>
      </div>
